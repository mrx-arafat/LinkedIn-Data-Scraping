...
2. **Search Filters Pagination Scraper** - Scrape connections via pagination with advanced filtering (recommended method)
...
| **Connections** | Scrape all connections via pagination (recommended) | `npm run scrape:connections-via-pagination` | `search-results-*.json/csv` |
...
Scrapes connections via pagination with advanced filtering and full pagination support. This is the recommended method for scraping connections as it handles large connection lists more efficiently.
